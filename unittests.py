import unittest
from helper import cutter, found_duplication, weight_input_calibrator
...
class TestReply(unittest.TestCase):
    ...
    def test_find(self) -> None:
        self.assertEqual(found_duplication({'max': (['я', 1], ['тебя', 1], ['люблю', 2], ['я тебя', 2], ['тебя люблю', 3], ['я тебя люблю', 3])},
                                           [['max', 0]],
        ...
        self.assertEqual(found_duplication({'max': (['я', 1], ['тебя', 1], ['люблю', 2], ['я тебя', 2], ['тебя люблю', 3], ['я тебя люблю', 3])},
                                           [['max', 0]],
                                           ['2342324', '234234', '333', '2342324 234234', '234234 333', '2342324 234234 333']), [['max', 0]])
    ...
    def test_reply(self) -> None:
        ...
        self.assertEqual(reply_output('ывппвыыва ываывавыоадл', [['max', [['я', 1], ['тебя', 1], ['люблю', 2],
                                                                          ['я тебя', 2], ['тебя люблю', 3], ['я тебя люблю', 3]]]]), [])
        self.assertEqual(reply_output('2342324 234234 333', [['max', [['я', 1], ['тебя', 1], ['люблю', 2],
                                                                      ['я тебя', 2], ['тебя люблю', 3], ['я тебя люблю', 3]]]]), [])
